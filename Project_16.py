...
person_cascade = cv2.CascadeClassifier(
    os.path.join('/media/vsl/Data/Projects/SummerAI/opencv_python/front/cascades/haarcascade_fullbody.xml'))
cap = cv2.VideoCapture("/media/vsl/Data/Projects/SummerAI/opencv_python/_vds/vid6.mp4")
while True:
    r, frame = cap.read()
    if r:
